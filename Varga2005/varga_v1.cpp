...
dxdt_Vector_cytoplasmic = k_unpack*Complex_cytoplasmic - k_bind*Vector_cytoplasmic; // note: second term should be VECTOR DEGREDATION
...
dxdt_VectorBound_nuclear = 0; // dummy equation
// dxdt_Vector_nuclear = k_unpack*Complex_nuclear; // the second term is dropped because there is no corresponding vector being transported into nucleus
