# this script creates the ODE model for the LNP-mRNA model published in Apgar et al., 2018

using ModelingToolkit, DifferentialEquations, LinearAlgebra, Catalyst;
