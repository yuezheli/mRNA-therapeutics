...
// spleen
dxdt_A_sp_vas_LIP = Qsp*C_pl_LIP - Qsp * C_sp_vas_LIP - UPsp*C_sp_vas_LIP - rel*C_sp_vas_LIP*V_sp_vas;
dxdt_A_sp_exv_LIP = UPsp*C_sp_vas_LIP - rel*C_sp_exv_LIP*V_sp_exv; 

// liver
dxdt_A_li_vas_LIP = Qha*C_pl_LIP + Qsp * C_sp_vas_LIP + Qgi * C_gi_vas_LIP - Qli * C_li_vas_LIP  - UPli*C_li_vas_LIP - rel*C_li_vas_LIP*V_li_vas;
dxdt_A_li_exv_LIP = UPli*C_li_vas_LIP - rel*C_li_exv_LIP*V_li_exv;
